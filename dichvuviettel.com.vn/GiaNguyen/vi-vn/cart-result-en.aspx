<%@ Page Title="" Language="C#" MasterPageFile="~/Master/SiteEN.Master" AutoEventWireup="true" CodeBehind="cart-result-en.aspx.cs" Inherits="THVDev.vi_vn.cart_result_en" %>
...
<div class="container">
   <div class="box bgWhite">
        <div class=" headingBox hdb2 "><span>Cart</span></div>
        <div id="cart_page" class="bgWhite">

          <div class="row_th_cart">
            <h3 class="th_table_cart fl" style="width: 15%"> Image </h3>
            <h3 class="th_table_cart fl" style="width: 40%"> Product name </h3>
            <h3 class="th_table_cart fl" style="width: 15%"> Price </h3>
            <h3 class="th_table_cart fl" style="width: 10%"> Quantity </h3>
            <h3 class="th_table_cart fl" style="width: 20%"> Sum </h3>
          </div>
          ...
          <div class="foo-cart">
            <div class="total-cart">
              <p style="display: block"> Total sum:<span id="total-money"> <span><asp:Label ID="Lbtotal" runat="server" Text=""></asp:Label></span> </span></p>
            </div>
          </div>
          <div class="button_cart"> 
          <a class=" btn btn-primary fl" href="/b1.html">Proceed to order >></a> 
            <a class=" btn btn-primary fl" href="/san-pham.html"> Buy more products</a>
            <asp:LinkButton ID="Lbcapnhap" runat="server" CssClass=" btn btn-primary fl" OnClick="Lbcapnhap_Click">Update Cart</asp:LinkButton> 
          </div>
        </div>
        <!--end Cart Page--> 
      </div>
